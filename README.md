...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "saas.repository.database":

```bash
npx wrangler d1 create saas.repository.database
```
